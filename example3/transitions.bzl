...
def at90can128_12mhz_cc_binary(name, **kwargs):
    cc_binary_platforms(name = name, platforms = "//platforms:at90can128_12mhz", **kwargs)

def atmega328p_16mhz_cc_binary(name, **kwargs):
    cc_binary_platforms(name = name, platforms = "//platforms:atmega328p_16mhz", **kwargs)

def at90can128_12mhz_objcopy(name, **kwargs):
    objcopy_platforms(name = name, platforms = "//platforms:at90can128_12mhz", **kwargs)

def atmega328p_16mhz_objcopy(name, **kwargs):
    objcopy_platforms(name = name, platforms = "//platforms:atmega328p_16mhz", **kwargs)
